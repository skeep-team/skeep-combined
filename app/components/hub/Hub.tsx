...
const SLIDES: Slide[] = [
  { tag: "Overview", href: `${BASE_PATH}/pages/index.html`, external: true, thumbnail: { kind: "image", src: `${BASE_PATH}/thumbs/principle.jpg`, heading: ["내가 이 세상의", "주인공인 것처럼"] } },
  ...
  return (
    <AnimatePresence initial={false}>
      ...
      >
        ...
        {tag && (
          <span className={tag === "Overview" ? `${styles.cardTag} ${styles.cardTagOverview}` : styles.cardTag}>
            {tag}
          </span>
        )}
      </motion.div>
